...
LAB_URL = "https://0a6200ba0415da088224feea0095009a.web-security-academy.net" 

def main():
    print("⦗#⦘ Injection point: " + Fore.YELLOW + "stockApi")
    print(Fore.WHITE + "❯❯ Injecting payload to delete carlos using SSRF with input filter bypass.. ", end="", flush=True)
