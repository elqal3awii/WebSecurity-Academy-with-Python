...
LAB_URL = "https://0aa600dd04ff41cf826cde6a002b00a3.web-security-academy.net"
...
def try_to_find_valid_username(usernames_list):
    ...
    for counter, user in enumerate(usernames_list):
        ...
        if try_to_login.status_code == 200:
            text1_exist = text_exist_in_response("<!-- -->", try_to_login)
            text2_exist = text_exist_in_response("password\.", try_to_login)            
            ...
            if text1_exist and not text2_exist:  
                return user  
